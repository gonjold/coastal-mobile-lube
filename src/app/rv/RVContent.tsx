...
const valueProps = [
  {
    title: "Your rig stays put",
    desc: "RV parks, campsites, storage lots, driveways. Wherever your rig is parked, that's where we work.",
  },
  {
    ...
    <>
      ...
      <section className="relative overflow-hidden" style={{ backgroundColor: "#0B2040" }}>
        ...
        <div
          ...
          style={{ backgroundImage: `url('${cld(images.heroRV, 'heroImproved')}')` }}
        />

...
import ServicePreviewPanel from "@/components/services/ServicePreviewPanel";
import InlineEditForm from "@/components/services/InlineEditForm";
import CategoryList from "@/components/services/CategoryList";
import SelectedCategoryPanel from "@/components/services/SelectedCategoryPanel";
import AddCategoryModal, {
  type AddCategorySubmit,
} from "@/components/services/AddCategoryModal";
import { NAVY, ORANGE, ORANGE_DARK, BORDER } from "@/components/services/tokens";
...
export default function ServicesPage() {
  ...
  async function createCategory(
    ...
    try {
      ...
      toast.success(isFeatured ? "Featured block created" : "Category created");
